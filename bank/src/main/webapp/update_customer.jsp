...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/banking_app", "root", "Wj28@krhps");
    Statement stmt = con.createStatement();
    String query = "SELECT * FROM customers WHERE account_no = " + account_no;
...
">Update Record</span>
	...
	<img src="./image/bank4.png" style="height: 100vh;">
