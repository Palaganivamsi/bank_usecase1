	...
	<div class = "container"> 
	    ...
	    <%
	        ...
	        try {
	            ...
	            PreparedStatement stmt = con.prepareStatement("SELECT initial_balance FROM customers WHERE account_no = ?");
	   ...
	   <div style="max-width: 70vw;">
	    ...
	    <table border="1" id="transactions">
	        ...
	        <tbody>
	            ...
	            try {
	            	 Connection con = DatabaseConnection.getConnection();
	                PreparedStatement stmt = con.prepareStatement("SELECT * FROM (SELECT * FROM transactions WHERE account_no = ? ORDER BY transaction_date DESC LIMIT 10) AS recent_transactions ORDER BY transaction_date ASC");
	                stmt.setString(1, session.getAttribute("accountNo").toString());
	                ResultSet rs = stmt.executeQuery();
