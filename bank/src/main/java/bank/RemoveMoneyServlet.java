...
public class RemoveMoneyServlet extends HttpServlet {
    private static final String UPDATE_CUSTOMER_QUERY = "UPDATE customers SET initial_balance = initial_balance - ? WHERE account_no = ?";
    private static final String INSERT_TRANSACTION_QUERY = "INSERT INTO transactions (account_no, transaction_type, amount, transaction_date) VALUES (?, ?, ?, ?)";
